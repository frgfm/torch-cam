...
Answers to recurring support questions. For API details, see the [package reference](../../reference/methods/).

## Stable release vs. `main`

| Source            | Install                                                               | What you get                                                                                                  |
| ----------------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| **PyPI (stable)** | `pip install torchcam`                                                | Latest tagged release (see [changelog](../changelog/)).                                                       |
...
TorchCAM **0.4.x** requires **PyTorch ≥ 2.0**. See the [installation guide](../../getting-started/installation/) for environment setup.
...
- Compare your code with the [quick start](../../#quick-start) and [notebooks](../../getting-started/notebooks/).
